...
## Download Data
Go to releases of `kargaranamir/girt-data` repository (https://github.com/kargaranamir/girt-data/releases) and download the latest version of data.
...
You can also get the same files from https://zenodo.org/records/7724793
